    ...
    <section id="mapa" className="bg-stone-50 border-t border-stone-200">
      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-10 md:py-16">
        <motion.div 
          ...
          className="rounded-3xl overflow-hidden border border-stone-200/60 bg-stone-200 aspect-[4/3] md:aspect-video w-full flex items-center justify-center shadow-soft"
        >
