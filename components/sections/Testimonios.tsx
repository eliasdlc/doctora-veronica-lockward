                    ...
                    return (
                      <CarouselItem key={i} className="md:basis-1/3">
                        <article className={`p-8 rounded-2xl border bg-white text-center transition-all duration-500
                                            ${isActive ? "scale-100 opacity-100 shadow-soft border-brand-primary/20 ring-[4px] ring-brand-primary/5 cursor-default" : "scale-[0.88] opacity-40 shadow-sm border-stone-200 cursor-pointer pointer-events-auto"}`}
